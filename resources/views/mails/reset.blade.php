                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <div class="space-y-4">
                              <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">PC IMM Lampura</h1>
                              ...
                              {{-- <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Perkiraan waktu pengiriman pesanan Anda adalah pukul 18.10 - 18.20. Lacak pesanan Anda di situs web Hip Corp.</p> --}}
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    <p class="text-center text-muted mb-2" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="center">Anda menerima email ini karena kami menerima permintaan pengaturan ulang kata sandi untuk akun Anda. </p>
                                    ...
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Tautan pengaturan ulang kata sandi ini akan kedaluwarsa dalam 60 menit.
                                    ...
                                    Jika Anda tidak meminta pengaturan ulang kata sandi, tidak ada tindakan lebih lanjut yang diperlukan.
                                      ...
                                      Jika Anda mengalami masalah saat mengklik tombol "Reset Password", salin dan tempel URL di bawah ini ke peramban web Anda:
