...
<div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
  <label for="content">Isi Artikel / Konten</label>
...
<small class="mt-0 mb-5">Jenis Gambar yang didukung (PNG, JPG, JPEG, GIF), dan Ukuran Gambar maksimal 3MB</small>
<div class="form-group{{ $errors->has('image') ? ' has-error ':''}}">
  ...
  @if(isset($post) && $post->image !== null)
      <img id="preview_image"
            src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $post->image) }}"
