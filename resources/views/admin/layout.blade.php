...
<head>
    ...
    <title> @yield('title') | PC IMM Lampura</title>
...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="modalTitle">Judul Gambar</h5>
    ...
    <!-- Modal Bootstrap untuk menampilkan Gambar Dinamis -->
    <script>
        function showImageModal(imageUrl, imageTitle) {
            // Isi data gambar dan judul ke dalam modal
