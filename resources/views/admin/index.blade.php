  ...
  {{-- <div id="myModal" class="modal fade">
      <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
              ...
              {{-- </div>
              <div >
                  <p>Pastikan Anda Sudah Di Daftarkan Oleh Rayon Anda Sebagai Anggota Kader PC IMM Lampura.</p>
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Kader Pasca Darul Arqam Dasar <span>| (DAD)</span></h5>
            ...
            <div class="col">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Kader Pasca Darul Arqam Madya <span>| (DAM)</span></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-people"></i>
                    </div>
            ...
            <div class="col">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Kader Pasca Darul Arqam Paripurna <span>| (DAP)</span></h5>
            ...
            <div class="col">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Kader Pasca Pelatihan Khusus <span>| PPK</span></h5>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data Galeri / Gambar <span>Belum Diverifikasi</span></h5>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data Artikel / Blog <span>Belum Diverifikasi</span></h5>
                            ...
                            <td>
                                <form action="{{ route('posts.destroy', $post->id) }}"
                                    ...
                                    <a href="{{ route('posts.edit', $post->id) }}"
                                        class="btn btn-primary btn-sm float-left mr-1" title="Lihat Artikel">
