        ...
        <h2 class="text-center my-5">Edit Gambar Utama</h2>
            <form action="/admin/page/{{ $pages->id }}" method="post"
                ...
                <div class="mb-3">
                    ...
                    <img src="{{ asset('sim-pcimm-lampura/public/storage/img/'.$pages['gambar']) }}" class="img-thumbnail" width="3000" >
                </div>
            
                <div class="mb-3">
                    <label for="gambar" class="form-label">Pilih Gambar Terbaru</label>
                    <input name="gambar" class="form-control" type="file" id="gambar" value="{{ $pages->gambar }}" >
                </div>
                <div class="my-3">
