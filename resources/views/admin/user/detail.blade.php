  ...
  <div class="col-lg-4">
    <div class="card mb-4">
      <div class="card-body text-center">
        <img src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $users->img ) }}" alt="avatar"
