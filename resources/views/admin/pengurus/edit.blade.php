...
<div class="card info-card sales-card">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="/admin/pengurus/{{ $penguruses->id }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="my-3">
                        ...
                        <input type="number" class="form-control" name="tahun" id="tahun" min="1900" max="{{ date('Y') }}"
                            value="{{ $penguruses->tahun }}">
                    </div>
            ...
            <div class="col-lg-4">
                <div class="text-center">
                    <img class="pt-4" src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $penguruses->img ) }}" alt="img" 
