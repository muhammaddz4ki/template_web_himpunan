                ...
                <div class="owl-carousel main-carousel position-relative">
                    ...
                    @foreach ($recent_posts->take(3) as $post)
                        <div class="position-relative overflow-hidden" style="height: 682px;">
                            @if ($post->image)
                                <img class="img-fluid h-100" src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $post->image) }}"
                    ...
                    @foreach ($trending->take(4) as $post)
                        <div class="col-md-6 px-0">
                            <div class="position-relative overflow-hidden" style="height: 341px;">
                                @if ($post->image)
                                    <img class="img-fluid w-100 h-100" src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $post->image) }}"
                                        style="object-fit: cover;">
                                @endif
                                <div class="overlay">
                                    <div class="mb-0">
                            ...
                            @foreach ($recent_posts as $post)
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                        @if ($post->image)
                                            <img class="img-fluid" src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $post->image) }}"
                                                alt=""
