            ...
            <div class="col-lg-8">
                ...
                <article class="my-5">
                    ...
                    <header class="mb-4">
                        ...
                        <figure class="mb-4">
                            <img class="img-fluid rounded" src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $post->image) }}" alt="..."/>
                        </figure>
                        <!-- Post content-->
                        @endif
                        <!-- Post title-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex mb-4">
                                <div class="flex-shrink-0">
                                  <img class="rounded-circle" style="width: 50px; height:50px; object-fit:cover" src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $comment->user->img ) }}" alt=""/></div>
                                <div class="ms-3">
