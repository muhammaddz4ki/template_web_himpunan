...
<!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css /> -->
      <div class="col-md-4 col-sm-6 mb-4 mb-lg-0">
          <div class="box mb-3">
              <img src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $galer->img ) }}"class="position-absolute top-50 start-50 translate-middle" >
              <div class="box-content mr-2">
                ...
                <a href=" /profile/{{ $galer->user->slug }}"><span class="title">{{ $galer->user->username }} @if($galer->user->centang == '1')
                  ...
                  <ul class="icon mt-4">
                      <li><a href="{{ asset('sim-pcimm-lampura/public/storage/img/' . $galer->img ) }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{ $galer['judul'] }}"><i class="bi bi-plus"></i></a></li>
                  </ul>
              </div>
          </div>
      </div>
