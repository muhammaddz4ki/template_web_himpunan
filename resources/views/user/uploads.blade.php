          ...
          <div class="card">
            ...
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link " data-bs-toggle="tab" data-bs-target="#profile-settings">Artikel</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade pt-3" id="profile-gambar">
                  ...
                  enctype="multipart/form-data">
                  @csrf
                  <label for="galeri" class="text-uppercase fw-bold">Gambar yang di upload harus lanccape</label>
                  ...
                  <div class="my-3"></div>
                  <label for="judul" class="text-uppercase fw-bold">Judul Gambar</label>
