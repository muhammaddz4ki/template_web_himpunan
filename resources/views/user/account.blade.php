        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $user->img ) }}" alt="Profile" class="rounded-circle" style="height:200px; width:200px; object-fit: cover;">
              <h2></h2>
                  ...
                  <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{ asset('sim-pcimm-lampura/public/storage/img/' . $user->img ) }}" alt="Profile" style="height:200px">
                        <div class="pt-2">
                      ...
                      <div class="row mb-3">
                        <label for="bio" class="col-md-4 col-lg-3 col-form-label">Moto Hidup</label>
                        <div class="col-md-8 col-lg-9">
                      ...
                      <div class="row mb-3">
                        <label for="nim" class="col-md-4 col-lg-3 col-form-label">NPM</label>
                        <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="alamat" class="col-md-4 col-lg-3 col-form-label">Alamat Domisili</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="ttl" type="date" class="form-control" id="ttl" value="{{ $user->ttl }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="sma" type="text" class="form-control" id="sma" value="{{ $user->sma }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="thn_lulus" type="text" class="form-control" id="thn_lulus" value="{{ $user->thn_lulus }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="thn_kuliah" type="text" class="form-control" id="thn_kuliah" value="{{ $user->thn_kuliah }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="wa" type="text" class="form-control" id="wa" value="{{ $user->wa }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fb" type="text" class="form-control" id="fb" value="{{ $user->fb }}" placeholder="link profile facebook anda"> 
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="ig" type="text" class="form-control" id="ig" value="{{ $user->ig }}" placeholder="link profile instagram anda">
                      </div>
                    </div>
