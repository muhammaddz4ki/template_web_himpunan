...
class CategoryBookController extends Controller
{
  ...
  public function store(Request $request)
  {
      ...
      Alert::success('Mantap IMMawan & IMMawati', 'Category Buku Berhasil Ditambahkan');
  ...
  public function update($id, Request $request)
  {
    ...
    Alert::success('Mantap IMMawan & IMMawati', 'Category Buku Berhasil Di Ubah');
    return redirect('/admin/categorybooks/');
  }
  public function destroy($id)
  {
      ...
      $categorybook->delete();
      Alert::success('Mantap IMMawan & IMMawati', 'Category Buku Berhasil Dihapus');
      return redirect('/admin/categorybooks');
  }
}
