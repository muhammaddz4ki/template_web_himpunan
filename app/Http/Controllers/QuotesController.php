...
class QuotesController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      Alert::success('Mantap IMMawan & IMMawati', 'Quote Berhasil Ditambahkan');
    ...
    public function update($id, Request $request)
    {
      ...
      Alert::success('Mantap IMMawan & IMMawati', 'Quote Berhasil Di Ubah');
      return redirect('/admin/quotes');
    }
    public function destroy($id)
    {
        ...
        $quotes->delete();
        Alert::success('Mantap IMMawan & IMMawati', 'Quote Berhasil Dihapus');
        return redirect('/admin/quotes/');
    }
}
