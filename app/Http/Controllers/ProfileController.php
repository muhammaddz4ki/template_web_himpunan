...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        Alert::success('Mantap IMMawan & IMMawati', 'Profile Anda Sudah Di Perbaharui');
    ...
    public function newpassword(Request $request)
    {
      ...
      return redirect()->back()->with('Mantap IMMawan & IMMawati', 'Password Berhasil Diubah.');
  }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'judul' => 'required',
            'img' => 'required|image|mimes:gif,png,jpg,jpeg|max:3072', // 3072 KB = 3 MB
        ], [
            'img.required' => 'Gambar wajib diunggah.',
            'img.image' => 'File yang diunggah harus berupa gambar.',
            'img.mimes' => 'Gambar harus memiliki format gif, png, jpg, atau jpeg.',
            'img.max' => 'Gambar tidak boleh lebih besar dari 3 MB.',
        ]);
        ...
        Alert::success('Mantap IMMawan & IMMawati', 'Gambar Berhasil Ditambahkan');
    ...
    public function storepost(Request $request): RedirectResponse
    {
        ...
        // Validasi ukuran gambar (misalnya, maksimal 3MB)
        $request->validate([
            'image' => 'required|file|mimes:gif,png,jpg,jpeg|max:3072', // 3072 KB
        ], [
            'image.required' => 'Gambar wajib diunggah.',
            'image.file' => 'File yang diunggah harus berupa file.',
            'img.mimes' => 'Gambar harus memiliki format gif, png, jpg, atau jpeg.',
            'image.max' => 'Gambar tidak boleh lebih besar dari ' . (3072 / 1024) . ' MB.',
        ]);
        ...
        Alert::success('Mantap IMMawan & IMMawati', 'Postingan akan ditinjau terlebih dahulu oleh admin');
    ...
    // dd($perpus);
        ...
        Alert::success('Mantap IMMawan & IMMawati', 'File Berhasil Ditambahkan');
        return redirect('/profile');
    }
