...
class RayonController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Alert::success('Mantap IMMawan & IMMawati', 'Rayon Berhasil Ditambahkan');
    ...
    public function update($id, Request $request)
    {
        ...
        Alert::success('Mantap IMMawan & IMMawati', 'Rayon Berhasil Diubah');
        return redirect('/admin/rayon');
    }
    ...
    public function destroy($id)
    {
        $rayon = rayon::findOrFail($id);
        $rayon->delete();
        Alert::success('Mantap IMMawan & IMMawati', 'Rayon Berhasil Dihapus');
        return redirect('/admin/rayon');
    }
}
