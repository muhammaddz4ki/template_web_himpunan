...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $user_unmapaba = User::where('kaderisasi', 'Belum DAD')->count(); //total pengguna yang belum mapaba
        $user_pkn = User::where('kaderisasi', 'PPK')->count(); //total pengguna yang sudah pkn
        $user_pkl = User::whereIn('kaderisasi', ['DAP', 'PPK'])->count(); //total pkl
        $user_pkd = User::whereIn('kaderisasi', ['DAM', 'DAP', 'PPK'])->count(); //total pkd
        $user_mapaba = User::whereIn('kaderisasi', ['DAD', 'DAM', 'DAP', 'PPK'])->count(); // Total mapaba
        ...
        $mapaba_2024 = User::where('thn_mapaba', '2024')->count(); //total mapaba di tahun 
        $mapaba_2025 = User::where('thn_mapaba', '2025')->count(); //total mapaba di tahun 
    ...
    public function update($id, Request $request)
    {
      ...
      Alert::success('Mantap IMMawan & IMMawati', 'Banner Berhasil Di Ubah');
