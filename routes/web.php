...
use App\Http\Controllers\LaporanKaderController;
...
Route::middleware(['auth', 'role:1'])->prefix('admin')->group(function () {
    Route::get('/unverified-users', [UserVerificationController::class, 'index'])
        ->name('admin.user.verify.index');
        
    Route::put('/users/{user}/verify', [UserVerificationController::class, 'verify'])
        ->name('admin.user.verify');
        
    Route::delete('/users/{user}/reject', [UserVerificationController::class, 'reject'])
        ->name('admin.user.reject');
        
    Route::get('/users/{id}/details', [UserVerificationController::class, 'show'])
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/struktur-organisasi/{struktur_organisasi}/edit', [StrukturOrganisasiController::class, 'edit'])->name('struktur-organisasi.edit');
    Route::put('/struktur-organisasi/{struktur_organisasi}', [StrukturOrganisasiController::class, 'update'])->name('struktur-organisasi.update');
    Route::delete('/struktur-organisasi/{struktur_organisasi}', [StrukturOrganisasiController::class, 'destroy'])->name('struktur-organisasi.destroy');
});

// User Route (ubah nama route dan URL supaya tidak bentrok)
Route::get('/tentang/struktur-organisasi', [StrukturOrganisasiController::class, 'show'])
    ->name('struktur-organisasi.show');

    
Route::get('/admin/users/{id}', [UserController::class, 'show'])->name('admin.user.details');
...
Route::get('/pengurus', [PengurusController::class, 'show'])->name('pengurus.tahun');
...
Route::put('/register/store', [LoginController::class, 'store'])->name('store');
...
Route::middleware(['auth', 'role:1'])->group(function () {
  ...
  Route::middleware(['auth', 'role:1'])->group(function () {
    Route::get('/admin/laporan/kader', [LaporanKaderController::class, 'index'])->name('laporan.kader');
    Route::post('admin/laporan/kader/filter', [LaporanKaderController::class, 'filter'])->name('admin.laporan.kader.filter');
    Route::get('/admin/laporan/kader/export-pdf', [LaporanKaderController::class, 'exportPdf'])->name('laporan.kader.export-pdf');
  });
