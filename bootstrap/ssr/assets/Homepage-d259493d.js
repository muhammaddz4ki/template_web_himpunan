...
const Navbar = () => {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "appHeader bg-primary text-light", children: [
    /* @__PURE__ */ jsxs("div", { className: "left", children: [
      ...
      /* @__PURE__ */ jsx("h3", { style: { color: "yellow", paddingLeft: "10px", margin: 0 }, children: "PC IMM Lampura" })
    ] }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "section mt-4 mb-4", children: [
        ...
        users.data.map((user) => /* @__PURE__ */ jsx("div", { className: "transactions mb-4", children: /* @__PURE__ */ jsxs("a", { href: "app-transaction-detail.html", className: "item", children: [
